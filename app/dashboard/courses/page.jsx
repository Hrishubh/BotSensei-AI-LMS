    ...
    >
      ...
      {filteredCourses.length > 0 ? (
          ...
          {filteredCourses.map((course) => (
            ...
            >
              ...
              <div className="relative h-40 w-full overflow-hidden">
                ...
                />
                <div className="absolute top-2 right-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm px-2 py-1 rounded-md flex items-center text-sm">
              ...
              <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                  <span className={`text-xs font-medium px-2 py-1 rounded-full ${
                    ...
                    course.difficulty === 'Intermediate' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400' : 
                ...
                <h3 className="font-bold text-lg mb-1 line-clamp-1 text-gray-900 dark:text-white">{course.title}</h3>
                ...
                <Link href={`/course/${course.id}`}>
                  <button className="w-full mt-2 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 text-blue-600 dark:text-blue-400 py-2 rounded-lg font-medium flex items-center justify-center gap-1 transition-colors border border-gray-100 dark:border-gray-600">
        ...
        <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
          ...
          <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">No courses found</h3>
