            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Get notified about new BotSensei features</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 dark:text-black">Light</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 dark:text-black">System</span>
                  </button>
                </div>
              </div>
