...
export default function MathAiPage() {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: "Hello! I'm your BotSensei Math AI assistant powered by Google Gemini. Ask me any math problem, and I'll help you solve it step by step!"
    }
  ]);
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-180px)]">
      ...
      <div 
        ...
        className="flex-1 mb-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-lg relative bg-[#f8fafc] dark:bg-gray-800 bg-opacity-80 backdrop-blur-md"
      >
