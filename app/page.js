...
const features = [
  ...
  },
  {
    ...
    description:
      "BotSensei adapts to your learning style, creating customized notes, flashcards, and quizzes.",
    icon: FileQuestion,
...
const testimonials = [
  {
    content:
      "BotSensei completely transformed how I study. The AI explanations are clear and I love how it adapts to my learning style.",
    author: "Alex Johnson",
  ...
  {
    content:
      "As a teacher, I recommend BotSensei to all my students. It helps them practice and gain confidence in subjects they struggle with.",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight text-gray-900 dark:text-white">
                Meet <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">BotSensei</span>,<br />
      ...
      <section id="features" className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              BotSensei combines cutting-edge AI with proven learning methods to help you master any subject.
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              className="text-xl text-gray-500 dark:text-gray-300 max-w-2xl mx-auto"
            >
              Hear what our users have to say about their experience with BotSensei.
            </motion.p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Join thousands of students who are already studying smarter, not harder with BotSensei.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} BotSensei. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
